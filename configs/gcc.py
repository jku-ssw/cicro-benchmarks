...
harness.add_runtime('gcc-O3-fno-strict-aliasing', {"CC": "${GCC}", "AS": "as", "CFLAGS": "-std=gnu99 -O3 -fno-strict-aliasing"}, **gcc_kwargs)
harness.add_runtime('gcc-O3-fno-strict-overflow', {"CC": "${GCC}", "AS": "as", "CFLAGS": "-std=gnu99 -O3 -fno-strict-overflow"}, **gcc_kwargs)
harness.add_runtime('gcc-O3-fno-delete-null-pointer-checks', {"CC": "${GCC}", "AS": "as", "CFLAGS": "-std=gnu99 -O3 -fno-delete-null-pointer-checks"}, **gcc_kwargs)
